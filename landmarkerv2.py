...
# Create an instance of Landmarker
landmarker = Landmarker()

# Load a test image
image = cv2.imread(
    'src/server/utils/WhatsApp Image 2024-09-08 at 8.00.04 AM.jpeg')
print("Image shape:", image.shape)
# Test the Landmarker on the loaded image
...
if success:
    ...
    print("Normalized points shape:", points.shape)
    print("points.", points)
else:
